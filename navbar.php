...
<nav class="hidden lg:flex fixed top-0 left-0 right-0 h-20 bg-white shadow-sm z-50 items-center justify-between px-8 max-w-7xl mx-auto w-full transition-all">
    ...
    <div class="flex items-center gap-8 font-medium text-gray-500">
        ...
        <a href="order.php" class="transition hover:text-locatera-orange <?php echo ($currentPage == 'favorites.php') ? 'text-locatera-orange font-bold' : ''; ?>">
            Pesanan Saya
        </a>
...
<nav class="fixed bottom-0 left-0 right-0 h-16 bg-locatera-orange shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1)] z-40 lg:hidden rounded-t-2xl transition-all">
    <div class="flex justify-around items-center h-full text-white/80">
        ...
        <a href="index.php" class="text-center w-12 <?php echo ($currentPage == 'index.php') ? 'text-white' : 'hover:text-white'; ?>">
         ...
         <a href="order.php" class="text-center text-white/70 hover:text-white"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-7 h-7 mx-auto"><path stroke-linecap="round" stroke-linejoin="round" d="M15.182 15.182a4.5 4.5 0 0 1-6.364 0A4.5 4.5 0 0 1 12 7.5a4.5 4.5 0 0 1 2.573 7.682ZM21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM15.91 15.91a.75.75 0 0 0-1.06-1.06c-.529.529-1.22.8-1.94.8s-1.411-.271-1.94-.8a.75.75 0 0 0-1.06 1.06c.699.699 1.62.98 2.59.98s1.891-.281 2.59-.98Z" /></svg></a>
        ...
        <a href="profile.php" class="text-center w-12 <?php echo ($currentPage == 'profile.php') ? 'text-white' : 'hover:text-white'; ?>">
            <svg xmlns="http://www.w3.org/2000/svg" fill="<?php echo ($currentPage == 'profile.php') ? 'currentColor' : 'none'; ?>" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="w-7 h-7 mx-auto">
